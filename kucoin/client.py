...
class Client(object):
    ...
    def get_account_history(self, account_id, start=None, end=None, page=1, page_size=50):
        """Get an individual account
    ...
    def get_deposits(self, currency=None, status=None, start=None, end=None, page=None, page_size=None):
    ...
    def get_withdrawals(self, currency=None, status=None, start=None, end=None, page=None, page_size=None):
        """Get deposit records for a currency
